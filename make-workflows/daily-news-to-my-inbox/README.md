...
See [`Sample output.txt`](./Sample%20output.txt) for a real email generated by this automation. It includes:

- A 3-sentence executive summary covering AI-driven lending, DPI-led financial inclusion, and NBFC market dynamics
- 5 curated stories with "why it matters" context and source URLs
